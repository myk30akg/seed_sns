<?php 
  ...
  if(!empty($_POST)){
    ...
    // echo 'ほげ';
    //登録処理
    //SQL文でデータ登録するには、INSERT文を使用する
    //mysqli関数群を使用してデータを操作する流れ

    //①sql文を用意する
    // $sql = 'INSERT INTO `members` SET `nick_name`="ほげ", `email`="hoge@gmail.com", `password`="hogehoge", `picture_path`="hoge.jpg", `created`=NOW()';
